...
class TestIntegrations(TestCase):
    ...
    def test_add_empty_business_name(self):
        ...
        reponse=self.app.post('http://127.0.0.1:5000/api/auth/v1/business', 
    ...
    def test_add_empty_business_description(self):
        ...
        self.assertEqual(response.status_code,400)
        response_msg = json.loads(response.data.decode("UTF-8"))
        self.assertIn("Description name cannot be empty", response_msg['Message'])
    ...
    def test_business_can_be_edited(self):
        ...
        data=ditc(businessname="Ramtoms",description="sell iron boxes",category="electronics",location="juja"))
        self.assertEqual(response.status_code,200)
